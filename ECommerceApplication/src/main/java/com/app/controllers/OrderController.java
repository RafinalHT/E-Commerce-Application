...
public class OrderController {
	...
	public ResponseEntity<OrderDTO> orderProducts(@PathVariable String email, @PathVariable Long cartId, @PathVariable String paymentMethod, @RequestBody CreateAddressDTO createAddressDTO) {
		OrderDTO order = orderService.placeOrder(email, cartId, paymentMethod, createAddressDTO);
